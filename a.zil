...
world of the Great Underground Empire in the Zork Trilogy and the other 
works of interactive fiction from Infocom.\" With that, he leaves you to 
ponder your fate. Very odd, to say the least.|
" CR>
	       <FINISH>)
	      (<EQUAL? .MODE ,F-FIRST?>
	       <COND (<PROB 33>
...
ordinary mortal and an adventurer!\" It is the last thing you hear." CR CR>
		<COND (<OR <NOT <FSET? ,MAP ,TOUCHBIT>>
		       ...
		       <TELL "?" CR CR>)>
		 <TELL
"If you would like to try again, you may do so from the menu. Press the 
RETURN (or ENTER) key to restart the Sampler"> ;this will never work-DA
		<COND (<YES?>
		       <RESTART>)
		      (T
		       <FINISH>)>)>>
